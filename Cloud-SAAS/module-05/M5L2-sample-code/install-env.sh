...
cd /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-05/M5L2-sample-code
# Pull latest changes
#sudo -u ubuntu git pull

sudo cp /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-05/M5L2-sample-code/default /etc/nginx/sites-available/default
