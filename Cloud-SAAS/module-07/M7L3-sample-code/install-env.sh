...
cd /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-07/M7L3-sample-code

sudo cp /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-07/M7L3-sample-code/default /etc/nginx/sites-available/default
