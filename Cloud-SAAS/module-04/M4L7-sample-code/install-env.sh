...
cd /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-04/M4L7-sample-code

sudo cp /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-04/M4L7-sample-code/default /etc/nginx/sites-available/default
