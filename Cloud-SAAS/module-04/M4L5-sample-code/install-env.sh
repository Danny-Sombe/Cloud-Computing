...
cd /home/ubuntu
sudo -u ubuntu npm install @aws-sdk/client-s3 @aws-sdk/client-sns @aws-sdk/client-rds @aws-sdk/client-secrets-manager express multer multer-s3
...
cd /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-04/M4L5-sample-code

sudo cp /home/ubuntu/Cloud-Computing/Cloud-SAAS/module-04/M4L5-sample-code/default /etc/nginx/sites-available/default
