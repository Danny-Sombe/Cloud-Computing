...
cd /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-06/M6L6-sample-code

sudo cp /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-06/M6L6-sample-code/default /etc/nginx/sites-available/default
