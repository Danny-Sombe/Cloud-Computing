...
cd /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-06/M6L7-sample-code

sudo cp /home/ubuntu-jammy/Cloud-Computing/Cloud-SAAS/module-06/M6L7-sample-code/default /etc/nginx/sites-available/default
